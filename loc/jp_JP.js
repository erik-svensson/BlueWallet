module.exports = {
  ...
  airdrop: {
    ...
    community: {
      header: 'エアドロップ報酬',
      name: 'コミュニティ',
      description: '報酬とコミュニティの進捗を確認する',
      carouselItemHeader: 'コミュニティの進捗',
      wallet: 'ウォレット',
      wallets: 'ウォレット',
      airdropParticipants: 'エアドロップ参加者',
      goal: '{order}のゴール：',
      unlockToIncrease: 'ロックを解除してエアドロップを${reward}に増やす',
      thresholdWallets: '{threshold}ウォレット',
    },
    circularWalletBalance: {
      yourBalance: '残高',
    },
    createWallet: {
      doYouWantToTakePart: 'エアドロップに参加しますか？',
      title: 'エアドロップの登場！',
    },
    dashboard: {
      createNewWallet: '新しいウォレットを作成する',
      desc1: '期限が過ぎる前にウォレットを追加しましょう。',
      desc1WithWallets: '進捗を確認しながら、さらにウォレットを登録できます。',
      desc2: 'エアドロップに参加するには、ウォレットを作成または追加します。',
      cantConnectToServerLine1: 'サーバーに接続できませんでした。',
      cantConnectToServerLine2: '数分後にもう一度お試しください。',
      loading1: 'サーバーを待っています。',
      loading2: '数秒かかる場合があります。',
      availableWallets: '利用可能なウォレット',
      registeredWallets: '登録済のウォレット',
    },
    itIsAlive: {
      subtitle: 'エアドロップが登場！',
      description: 'BTCV初のエアドロップです。\nぜひ確認して報酬をゲットしましょう！',
      notNow: '今は結構です',
      learnMore: '詳細を見る',
    },
    requirements: {
      soundsGreat: '関心があります！',
      subtitle: 'Bitcoin Vaultの一員でいてくださり、ありがとうございます',
      description: '一緒にいてくださることに対して${airdropTotalDollarsToShare}相当のBTCVをお支払いします！',
      listHeader: 'エアドロップの要件：',
      points: {
        '0': '任意のBTCVウォレット',
        '1': 'ウォレットの最小保管金額は{airdropMinimumBTCVRequired}BTCV',
      },
      rewardExplanation: '*報酬は、一般プールにあるコイン数に基づきます。',
      termsAndConditions: {
        read: '[Terms and Conditions]を読む',
    ...
    walletsCarousel: {
      ...
      shark: '',
      whale: '',
      yourNextGoal: 'あなたの{order}:',
      avatarTeaser: '{goalName}になる：{goalThreshold} {unit}',
      youReachedGoal: 'ゴールを達成しました: ',
    },
    finished: {
      subtitle: 'エアドロップが終了しました！',
      stayTuned: '{period}はさらにご期待ください',
      shareIt: '友達にシェアしよう',
      checkOutData: 'もっと知りたいですか？',
      readFullReport: 'こちらからレポート全文をお読みいただけます',
      medium: 'Medium',
      registeredWallets: '登録済のウォレット',
    },
    createWalletSuccess: {
      success: 'おめでとうございます！\n　エアドロップの登録が完了しました！',
      successWithNotifications: 'おめでとうございます！\n　通知とエアドロップの登録が完了しました！',
      shareIt: '友達にシェアして{rewardValue} BTCVをゲットしよう！*',
      maxReward: '*1つのウォレットの最大報酬額は {rewardValue} BTCVです。',
      successCompletedButton: '{routeName}に移動',
    },
  },
  termsConditions: {
    header: '利用規約',
  ...
  notifications: {
    main: {
      header: '通知',
      title: '通知設定',
      description: '受信する通知を選択できます。',
    },
    email: {
      header: 'メール通知',
      description: 'メールアドレスを変更できます。選択したウォレットからの取引通知を送信するために使用されます。',
      title: 'ウォレット',
    },
    push: {
      header: 'プッシュ通知',
      title: 'ウォレット',
      description: 'プッシュ通知の設定を変更できます。選択したウォレットからの取引通知を送信するために使用されます。',
    },
    emailNotificationsNavigate: 'メール通知',
    pushNotificationsNavigate: 'プッシュ通知',
