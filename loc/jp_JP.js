module.exports = {
  ...
  security: {
    jailBrokenPhone:
      'お客様のデバイスが脱獄されたと思われます。これはセキュリティの問題、クラッシュまたその他の問題に繋がる可能性があります。脱獄されたデバイスでGoldWalletの利用は進めておりません。アプリを終了してください。',
    rootedPhone:
      'お客様のデバイスはルーティングされたものと思われます。これはセキュリティの問題、クラッシュまたその他の問題に繋がる可能性があります。ルーティングされたデバイスでGoldWalletの利用は進めておりません。アプリを終了してください。',
    noPinOrFingerprintSet: '機器がセキュリティされる前にGoldWalletを利用するのは進めておりません。',
    title: 'セキュリティ問題',
  },
};
