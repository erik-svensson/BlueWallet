module.exports = {
  ...
  airdrop: {
    ...
    community: {
      header: '空投奖励 ',
      name: '社区',
      description: '查看奖励和社区进度 ',
      carouselItemHeader: '社区进展 ',
      wallet: '钱包 ',
      wallets: '钱包 ',
      airdropParticipants: 'Airdrop participants',
      goal: '{order} 目标： ',
      unlockToIncrease: '解锁以将空投增加到 ${reward} ',
      thresholdWallets: '{threshold} 钱包 ',
    },
    circularWalletBalance: {
      yourBalance: '您的余额',
    },
    createWallet: {
      doYouWantToTakePart: '你想参加空投吗？ ',
      title: '空投已上线！ ',
    },
    dashboard: {
      createNewWallet: '创建新钱包 ',
      desc1: '在时间用完之前添加您的钱包。 ',
      desc1WithWallets: '查看您的进度并注册更多钱包。 ',
      desc2: '创建或添加钱包以参与空投。 ',
      cantConnectToServerLine1: '无法连接到服务器。',
      cantConnectToServerLine2: '请在几分钟后再试一次。 ',
      loading1: '等待服务器。 ',
      loading2: '这可能需要几秒钟。',
      availableWallets: '可用钱包 ',
      registeredWallets: '注册钱包 ',
    },
    itIsAlive: {
      subtitle: '空投已上线！',
      description: '我们的首个 BTCV 空投就在这里。\n快来看看领取奖励吧！ ',
      notNow: '不是现在',
      learnMore: '了解更多',
    },
    requirements: {
      soundsGreat: 'Sounds great!',
      subtitle: '感谢您成为Bitcoin Vault的一员 ',
      description: '我们想与您分享 ${airdropTotalDollarsToShare}等值的 BTCV 来奖励您和我们的共同努力！ ',
      listHeader: '空投要求： ',
      points: {
        '0': '任何 BTCV 钱包 ',
        '1': '至少 {airdropMinimumBTCVRequired} BTCV 存储在钱包中* ',
      },
      rewardExplanation: '*您的奖励取决于您在普通池中拥有多少币。 ',
      termsAndConditions: {
        read: '阅读',
    ...
    walletsCarousel: {
      ...
      shark: '',
      whale: '',
      yourNextGoal: '您的 {order}:',
      avatarTeaser: '成为{goalName}：{goalThreshold} {unit} ',
      youReachedGoal: '你达到了目标： ',
    },
    finished: {
      subtitle: '空投结束！',
      stayTuned: '请继续关注{period}的更多信息 ',
      shareIt: '与他人分享 ',
      checkOutData: '想了解更多吗？',
      readFullReport: '阅读我们的完整报告 ',
      medium: '中等',
      registeredWallets: '注册钱包 ',
    },
    createWalletSuccess: {
      success: '太棒了！\n   您已成功注册空投！ ',
      successWithNotifications: '太棒了！\n   您已成功订阅通知并注册空投！ ',
      shareIt: '与他人分享并获得 {rewardValue} BTCV 奖励！*',
      maxReward: '*一个钱包的最大奖励额度为{rewardValue} BTCV。 ',
      successCompletedButton: '转到{routeName} ',
    },
  },
  termsConditions: {
    header: '条款和条件',
  ...
  contactCreate: {
    ...
    subtitle: '新联系人',
    successButton: '返回通讯录',
    successDescription: '太棒啦！您已经成功添加联系人。',
    successTitle: '成功',
  },
  contactDelete: {
  ...
  notifications: {
    main: {
      header: '通知 ',
      title: '配置通知',
      description: '您可以选择要接收的通知。',
    },
    email: {
      header: '电子邮件通知 ',
      description: '您可以更改您的电子邮件地址。 它用于从选定的钱包向您发送交易通知。',
      title: '钱包',
    },
    push: {
      header: '推送通知',
      title: '钱包',
      description: '您可以更改推送通知设置。 它用于从选定的钱包向您发送交易通知。',
    },
    emailNotificationsNavigate: '电子邮件通知 ',
    pushNotificationsNavigate: '推送通知',
