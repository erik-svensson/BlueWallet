const tr = {
  ...
  wallets: {
    ...
    add: {
      ...
      legacyHDP2SH: '24 kelimelik tek bir çekirdekten oluşturulmuş bir P2SH adresleri ağacı içerir',
      LegacyP2SH: 'Tek bir P2SH adresi içerir',
      LegacyHDSegWit: '24 kelimelik tek bir çekirdekten oluşturulmuş bir native segwit adresleri ağacı içerir',
