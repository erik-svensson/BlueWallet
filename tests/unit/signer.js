...
describe('unit - signer', function() {
  ...
  describe('signAndFinalizePSBT()', () => {
    ...
    it('should finalize Recovery tx on AR', () => {
      ...
      const txHex = signer.signAndFinalizePSBT(encodedPsbt, keyPairs, bitcoinjs.VaultTxType.Recovery);
      assert.strictEqual(
        txHex,
    ...
    it('should finalize Instant tx on AIR', () => {
      ...
      const txHex = signer.signAndFinalizePSBT(encodedPsbt, keyPairs, bitcoinjs.VaultTxType.Instant);
      assert.strictEqual(
        txHex,
